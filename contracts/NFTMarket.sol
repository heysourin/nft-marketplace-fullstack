...
contract NFTMarket is ReentrancyGuard {
    ...
    //Todo: Creating marketitem
    function createMarketItem(
        address nftContract,
        uint256 tokenId,
        uint256 price
    ) public payable nonReentrant {
        require(price > 0, "Price must be grater than 0 wei");
        require(
        ...
        //Trnasferring token ownership to the contract for this time being
...
//Todo: Returns NFTs that an user has purchased
    ...
    //Todo: NFTs that user has created herself
